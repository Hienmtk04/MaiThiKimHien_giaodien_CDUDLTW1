        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href=""><i class="fa fa-fw fa-bar-chart-o"></i> Quản lý danh mục</a>
                    </li>
                    <li>
                        <a href=""><i class="fa fa-fw fa-table"></i> Quản lý sản phẩm</a>
                    </li>
                    <li>
                        <a href=""><i class="fa fa-fw fa-user"></i> Quản lý người dùng</a>
                    </li>
                    <li>
                        <a href="<"><i class="fa fa-fw fa-edit"></i> Quản lý hóa đơn</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
